...
import jp.gardenall.instagramclone.data.CommentData
import jp.gardenall.instagramclone.data.Event
import jp.gardenall.instagramclone.data.PostData
import jp.gardenall.instagramclone.data.UserData
...
//        auth.signOut()
    ...
    private fun getGeneralFeed() {
        ...
        val differTime = 24 * 60 * 60 * 1000 // 1 day in mills
        db.collection(POSTS).whereGreaterThan("time", currentTime - differTime).get()
            .addOnSuccessListener {
