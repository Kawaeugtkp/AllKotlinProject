...
import jp.gardenall.a7minutesworkout.databinding.ItemExerciseStatusBinding
        ...
        when{
            model.getIsSelected() ->{
                holder.tvItem.background = ContextCompat.getDrawable(
                    holder.itemView.context, R.drawable.item_circular_thin_color_accent_border) // 一つ目のパラメーターは
            // activity内であればthisとかになっていたけど今回はそうではないので色々書いている
